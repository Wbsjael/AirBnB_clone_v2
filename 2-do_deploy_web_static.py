...
@runs_once
def do_pack():
    """  Creates a .tgz archive of the web_static directory. The archive is named based on the current timestamp."""
...
def do_deploy(archive_path):
    ...
    try:
        ...
        return False
def deploy:
    """Orchestrates the process of creating and deploying the archive."""
